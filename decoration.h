...
#define DEC_DEF(NAME,...) class NAME: public Decoration{public: NAME(int x, int y, int w, int h, ##__VA_ARGS__);private: virtual bool validateDecoration(char *tiles);virtual bool reserveDecoration(char *tiles);virtual void renderDecoration(Tile *tiles, TileFactory *tileFactory);
...
#define DEC_REN(NAME) void NAME::renderDecoration(Tile *tiles, TileFactory *tileFactory)
...
class Decoration
{
    ...
    protected:
        ...
        virtual void renderDecoration(Tile *tiles, TileFactory *tileFactory) = 0;
};
